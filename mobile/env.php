...
switch ($env) {
    ...
    case 'devlb':
        ...
        define('__BRAND_URL__','//hp.dev.brand.adidas.com/com/storefinder/mobile/');
        break;
    //case 'uat':
    case 'qa':
		...
		define('__PLACES_URL__','//staging.placesws.adidas-group.com/API/');
        define('__BRAND_URL__', '//staging.adidas.com/com/storefinder/mobile/');
		break;
    case 'prod':
        ...
        define('__BRAND_URL__', '//www.adidas.com/com/storefinder/mobile/');
		break;
     default:
        $BASE='//localhost/storefinder';
        $CDN='//localhost/storefinder/CDN_PATH';
		define('__PLACES_URL__','//staging.placesws.adidas-group.com/API/');
        define('__BRAND_URL__', '//localhost/storefinder/mobile/');
}
//echo __BRAND_URL__; 
